...
| openai-skills | https://github.com/openai/skills.git | auto | auto | tracked | openai | review-required | grouped monorepo pilot for smart discovery under packages/skills-catalog/skills |
