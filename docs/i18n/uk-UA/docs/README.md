...
| 📦 **Catalog** | 📌 171 skills | 171 native catalog skills across 16 active categories, with 38 curated English derivatives in `skills_omni` and 7 fully backed bundles |
