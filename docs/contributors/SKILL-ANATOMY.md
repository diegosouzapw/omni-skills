...
The skill version is independent from the npm package version. The package is currently `0.1.4`, but existing skills can validly remain on their own semantic version.
