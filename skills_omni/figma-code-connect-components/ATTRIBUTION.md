# Attribution for figma-code-connect-components
...
- Upstream skill id: `figma-code-connect-components`
- Upstream title: `Code Connect Components`
- Upstream path: `skills/figma-code-connect-components/`
