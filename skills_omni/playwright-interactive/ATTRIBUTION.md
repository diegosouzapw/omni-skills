# Attribution for playwright-interactive
...
- Upstream skill id: `playwright-interactive`
- Upstream title: `Playwright Interactive Skill`
- Upstream path: `skills/playwright-interactive/`
