# Attribution for figma-create-new-file
...
- Upstream skill id: `figma-create-new-file`
- Upstream title: `createnewfile — Create a New Figma File`
- Upstream path: `skills/figma-create-new-file/`
